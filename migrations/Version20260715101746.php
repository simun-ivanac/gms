...
/**
 * Migration Version20260715101746.
 */
...
/**
 * Class Version20251122164743.
 */
final class Version20260715101746 extends AbstractMigration
{
	/**
	...
	public function up(Schema $schema): void
	{
		...
		$this->addSql('CREATE TABLE plan (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, price INT NOT NULL, currency VARCHAR(255) NOT NULL, duration_in_days INT NOT NULL, are_visitations_limited TINYINT(1) NOT NULL, num_of_visitations INT DEFAULT NULL, time_period VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
		...
		$this->addSql('ALTER TABLE visitation ADD CONSTRAINT FK_B39D86A7597D3FE FOREIGN KEY (member_id) REFERENCES `member` (id)');
		$this->addSql('ALTER TABLE visitation ADD CONSTRAINT FK_B39D86AC292CD19 FOREIGN KEY (team_member_id) REFERENCES team_member (id)');
		// phpcs:enable
	}
	...
	public function down(Schema $schema): void
	{
		...
		$this->addSql('ALTER TABLE visitation DROP FOREIGN KEY FK_B39D86A7597D3FE');
		$this->addSql('ALTER TABLE visitation DROP FOREIGN KEY FK_B39D86AC292CD19');
